...
public class course_actuelle_depot extends Activity implements View.OnClickListener  {
     ...
     *On lui attribue la page xml content_course_actuelle_depot
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_course_actuelle_depot);
        ...
        //initialisation du textview et écriture dedans
        TextView tv = (TextView) findViewById(R.id.titre);
        tv.setText(getResources().getString(R.string.title_activity_course_actuelle_depot));

        global = (Global) getApplicationContext();

        if(global.getCourseCourante() != null){
            propo = global.getCourseCourante();
            TextView adresse_depart = (TextView) findViewById(R.id.tv_adresse_arrivee2);
        ...
        Button buttonOne = (Button) findViewById(R.id.terminer);
    ...
    /**
     * cette méthode permet lorsqu'on clique sur le bouton client terminer la course, nous sommes redirigés sur la page accueil
     * et il y a un toast qui s'affiche
     * @param v
     */
// methode d'action de boutons
    public void onClick(View v){
        ...
        switch (v.getId()) {
            case R.id.terminer:
                ...
                editor.putString("statut", getResources().getString(R.string.statut_libre));
                editor.putString("idCourse", null);
                editor.commit();
                api.postMajStatut(global.getTel(), getResources().getString(R.string.statut_libre), new Callback<ResponseModel>() {
                ...
                startActivity(new Intent(course_actuelle_depot.this, MainActivity.class));
                break;
            case R.id.imagebouton4:
                startActivity(new Intent(course_actuelle_depot.this, info_station.class));
                break;
            case R.id.imagebouton3:
                startActivity(new Intent(course_actuelle_depot.this, message_centrale.class));
                break;
            ...
            case R.id.imagebouton2:
                ...
                switch(item){
                    case "Charge" :
                        startActivity(new Intent(course_actuelle_depot.this, course_actuelle.class));
                        break;
                    case "Destination" :
                        startActivity(new Intent(course_actuelle_depot.this, course_actuelle_depot.class));
                        break;
                    default :
